...
class AlipaySettleService extends AlipayService
{
     ...
     * @param float|string $money 分账的金额
     * @return mixed {"trade_no":"支付宝交易号","settle_no":"支付宝分账单号"}
     * @throws Exception
     */
    public function order_settle(string $trade_no, string $type, string $account, float|string $money): mixed
    {
     ...
     * @throws Exception
     */
    public function order_settle_unfreeze(string $trade_no): mixed
    {
        $apiName = 'alipay.trade.order.settle';
        $out_request_no = date("YmdHis") . rand(11111, 99999);
        $bizContent = [
     ...
     * @throws Exception
     */
    public function order_settle_query(string $settle_no): mixed
    {
     ...
     * @throws Exception
     */
    public function rate_query(): mixed
    {
     ...
     * @throws Exception
     */
    public function order_settle_refund(string $trade_no, string $type, string $account, float|string $money): bool
    {
