...
class AlipayBillService extends AlipayService
{
     ...
     * @throws Exception
     */
    public function sellQuery(string $start_time, string $end_time, int $page_no = 1, int $page_size = 2000): mixed
    {
     ...
     * @throws Exception
     */
    public function buyQuery(string $start_time, string $end_time, int $page_no = 1, int $page_size = 2000): mixed
    {
     ...
     * @param int $page_no 分页号，从1开始
     * @param int $page_size 分页大小1000-2000，默认2000
     * @param string|null $bill_user_id 指定用户做账单查询
     * @return mixed {"page_no":"1","page_size":"2000","total_size":"10000","detail_list":[]}
     * @throws Exception
     */
    public function accountlogQuery(string $start_time, string $end_time, int $page_no = 1, int $page_size = 2000, ?string $bill_user_id = null): mixed
    {
        ...
        if ($bill_user_id !== null) {
            $bizContent['bill_user_id'] = $bill_user_id;
        }
        return $this->aopExecute($apiName, $bizContent);
    }
     ...
     * @throws Exception
     */
    public function transferQuery(string $start_time, string $end_time, int $page_no = 1, int $page_size = 2000): mixed
    {
     ...
     * @throws Exception
     */
    public function balanceQuery(): mixed
    {
     ...
     * @throws Exception
     */
    public function ereceiptApply(string $type, string $key): mixed
    {
     ...
     * @throws Exception
     */
    public function ereceiptQuery(string $file_id): mixed
    {
