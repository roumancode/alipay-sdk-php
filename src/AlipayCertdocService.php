...
class AlipayCertdocService extends AlipayService
{
     ...
     * @throws Exception
     */
    public function preconsult(string $cert_name, string $cert_no): mixed
    {
     ...
     * @throws Exception
     */
    public function consult(string $verify_id, string $auth_token): mixed
    {
     ...
     * @return void|string
     */
    public function oauth(string $redirect_uri, string $verify_id, ?string $state = null, bool $is_get_url = false)
    {
        $param = [
            'app_id' => $this->appId,
            'scope' => 'id_verify',
