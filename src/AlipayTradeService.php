...
class AlipayTradeService extends AlipayService
{
     ...
     */
    public function scanPay(array $bizContent): mixed
    {
     ...
     */
    public function qrPay(array $bizContent): mixed
    {
     ...
     */
    public function jsPay(array $bizContent): mixed
    {
     ...
     * @throws Exception
     */
    public function query(?string $trade_no = null, ?string $out_trade_no = null): mixed
    {
     ...
     * @throws Exception
     */
    public function queryResult(?string $trade_no = null, ?string $out_trade_no = null): bool
    {
        $result = $this->query($trade_no, $out_trade_no);
        return $result['trade_status'] === 'TRADE_SUCCESS' || $result['trade_status'] === 'TRADE_FINISHED' || $result['trade_status'] === 'TRADE_CLOSED';
    }
     ...
     */
    public function refund(array $bizContent): mixed
    {
     ...
     * @throws Exception
     */
    public function refundQuery(array $bizContent): mixed
    {
     ...
     * @throws Exception
     */
    public function cancel(array $bizContent): mixed
    {
     ...
     * @throws Exception
     */
    public function close(array $bizContent): mixed
    {
     ...
     * @throws Exception
     */
    public function downloadurlQuery(array $bizContent): mixed
    {
     ...
     */
    public function directPayParams(array &$bizContent, string $settle_period_time = '1d'): void
    {
        if (empty($this->smid)) {
            throw new Exception("子商户SMID不能为空");
        }
        if (str_contains($this->smid, ',')) {
     ...
     * @param float|string $settle_amount 结算金额
     ...
     */
    public function settle_confirm(string $trade_no, float|string $settle_amount, bool $freeze = false): mixed
    {
     ...
     */
    public function mergePrecreatePay(array $bizContent): mixed
    {
     ...
     */
    public function mergeCreate(array $bizContent): mixed
    {
     ...
     * @throws Exception
     */
    public function preAuthUnfreeze(array $bizContent): mixed
    {
     ...
     * @throws Exception
     */
    public function preAuthCancel(array $bizContent): mixed
    {
     ...
     * @throws Exception
     */
    public function preAuthQuery(array $bizContent): mixed
    {
