...
class AlipayOauthService extends AlipayService
{
     ...
     * @return void|string
     */
    public function oauth(string $redirect_uri, ?string $state = null, string $scope = 'auth_base', bool $is_get_url = false)
    {
        $param = [
            'app_id' => $this->appId,
            'scope' => $scope,
     ...
     * @throws Exception
     */
    public function getToken(string $code, string $grant_type = 'authorization_code'): mixed
    {
     ...
     * @return void|string
     */
    public function appOauth(string $redirect_uri, ?string $state = null, bool $is_get_url = false)
    {
        $param = [
            'app_id' => $this->appId,
            'redirect_uri' => $redirect_uri,
     ...
     */
    public function appOauthAssign(string $redirect_uri, array $app_types, ?string $state = null): array
    {
        $param = [
            'platformCode' => 'O',
     ...
     * @throws Exception
     */
    public function getAppToken(string $code, string $grant_type = 'authorization_code'): mixed
    {
     ...
     * @throws Exception
     */
    public function appQuery(string $appAuthToken): mixed
    {
     ...
     * @param string $key 密钥
     * @return string 解密后的手机号码
     * @throws Exception
     */
    public function decryptMobile(array $response, string $key): string
    {
