...
$is_userid = is_numeric($payee_account) && str_starts_with($payee_account, '2088') && strlen($payee_account) === 16;

//发起转账请求
try {
    $transfer = new \Alipay\AlipayTransferService($alipay_config);
    $result = $transfer->transferToAccount($out_trade_no, $money, (int)$is_userid, $payee_account, $payee_real_name, $payer_show_name);
